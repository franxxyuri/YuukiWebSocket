...
console.log('Starting Windows-Android Connect WebSocket Server on port 8928...');
console.log('==================================================');

// Start server function
async function startServer() {
  try {
    console.log('Starting WebSocket server on port 8928...');
    ...
    console.log('Server listening on port: 8928');

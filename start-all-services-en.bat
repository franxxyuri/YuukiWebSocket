...
echo Starting Vite development server (port 8080)...

start /b cmd /c "npx vite --config vite-config.js --host 0.0.0.0 --port 8080"
...
echo - Vite server: http://localhost:8080
